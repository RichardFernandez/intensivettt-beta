...
<a href="{{route('admin.recetas.create')}}" class="btn btn-info">Registrar nueva receta</a>

    <!--Buscador de insumos-->

        {!! Form::open(['route' => 'admin.recetas.index', 'method' => 'GET', 'class' => 'form-inline pull-right']) !!}
